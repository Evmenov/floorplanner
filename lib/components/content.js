...
var _agentViewer = require('./agents/agent-viewer');

var _agentViewer2 = _interopRequireDefault(_agentViewer);
...
function Content(_ref) {
  var width = _ref.width,
      ...
      updateCoordinats = _ref.updateCoordinats;
  ...
  switch (mode) {
    ...
    case constants.MODE_ROTATING_ITEM:
      return _react2.default.createElement(_viewer2d2.default, { state: state, width: width, height: height, sidebarH: sidebarH, updateData: updateData, updateCoordinats: updateCoordinats });

    case constants.MODE_CONFIGURING_PROJECT:
      return _react2.default.createElement(_projectConfigurator2.default, { width: width, height: height, state: state, sidebarH: sidebarH });

    case constants.MODE_AGENTS_VIEWER:
      return _react2.default.createElement(_agentViewer2.default, { width: width, height: height, state: state, sidebarH: sidebarH });
