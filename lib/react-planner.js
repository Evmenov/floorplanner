    ...
    value: function render() {
      ...
      return (
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_export3.Content, _extends({ width: contentW + toolbarW, height: contentH + footerBarH, state: extractedState,
          ...
          _react2.default.createElement(_roomAdditional2.default, _extends({ width: roomInfoW, height: roomInfoH, state: extractedState, selectedObject: selectedObject, x: X, y: Y }, props))
        )
      );
    }
  }]);
