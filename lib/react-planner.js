...
var _menu = require('./components/modal-window/menu');

var _menu2 = _interopRequireDefault(_menu);

var _Drawer = require('./components/modal-window/Drawer');

var _Drawer2 = _interopRequireDefault(_Drawer);

var _ToolbarMaterial = require('./components/modal-window/ToolbarMaterial');

var _ToolbarMaterial2 = _interopRequireDefault(_ToolbarMaterial);

var _RoomInfo = require('./components/modal-window/RoomInfo');

var _RoomInfo2 = _interopRequireDefault(_RoomInfo);

var _Catalog = require('./components/modal-window/Catalog');

var _Catalog2 = _interopRequireDefault(_Catalog);

var _SettingsDialog = require('./components/modal-window/SettingsDialog');
  ...
  _createClass(ReactPlanner, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(Toolbar, _extends({ checked: this.state.checked,
        ...
        _react2.default.createElement(_ToolbarMaterial2.default, _extends({ width: sidebarW, height: sidebarH, state: extractedState,
          selectedObject: selectedObject }, prop)),
        _react2.default.createElement(FooterBar, _extends({ width: width, height: footerBarH, state: extractedState }, prop))
      )
